...
import '../shared/display_state.dart';
import 'crash_log_entry.dart';

/// Provider for the crash log service
final crashLogServiceProvider = Provider<CrashLogService>((ref) {
  return CrashLogService();
});

/// Provider for the list of crash logs
final crashLogsProvider = FutureProvider<List<CrashLogEntry>>((ref) async {
  final service = ref.watch(crashLogServiceProvider);
  return service.getCrashLogs();
});
