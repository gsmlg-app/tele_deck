...
class DisplayState {
  ...
  bool operator ==(Object other) {
    ...
    return other is DisplayState &&
        other.hasSecondaryDisplay == hasSecondaryDisplay &&
        other.secondaryDisplayId == secondaryDisplayId &&
        other.primaryWidth == primaryWidth &&
        other.primaryHeight == primaryHeight &&
        other.secondaryWidth == secondaryWidth &&
        other.secondaryHeight == secondaryHeight;
  }
